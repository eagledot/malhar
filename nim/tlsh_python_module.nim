...
proc from_hex_mine(data:string, reverse:bool = false):array[CODE_SIZE, uint8] =
    # data is supposed to be 64 hex encoded string, each two character correspond to a byte
...
let
    hash_1 = "0b0a0b31c89435177eac00bb7c24af23b345550ec5651d114072a105db50f213d14855"
    hash_2 = "0b0a0b31c89435177eac00bb7c241834fab550ec5651d114072a105db50f213d148444"
